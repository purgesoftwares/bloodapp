...
class DatabaseSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        User::create([
            'name' => 'admin',
            'email' => 'shankar.xtreem@gmail.com',
		...
		DB::statement("INSERT INTO `cities` (`id`, `name`, `state`) VALUES
...
(1393, 'Shahabad', 'Uttar Pradesh'),
(1394, 'Shahganj', 'Uttar Pradesh'),
(1395, 'Shahjahanpur', 'Uttar Pradesh'),
(1396, 'Shamli', 'Uttar Pradesh'),
(1397, 'Shamsabad', 'Uttar Pradesh'),
(1398, 'Shamsabad', 'Uttar Pradesh'),
...
(1525, 'Bilara', 'unknown'),
(1527, 'Budaun', 'unknown'),
(1528, 'Bulandshahr', 'Uttar Pradesh'),
(1529, 'Burla', 'unknown'),
